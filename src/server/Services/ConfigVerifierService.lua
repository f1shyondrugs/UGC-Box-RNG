-- ConfigVerifierService.lua
-- This service is responsible for verifying the game's configuration (GameConfig)
-- to ensure that item types match their asset IDs on the marketplace. This helps
